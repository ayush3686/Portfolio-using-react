...
const ContactCard = ({ 
  ...
  >
    ...
    <div>
      ...
      <p className="text-lg font-medium break-words overflow-hidden min-w-0">{value}</p>
    </div>
  </motion.a>
);
  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      title: "EMAIL",
      value: "ayushraj.singhpra2004@gmail.com",
      link: "mailto:ayushraj.singhpra2004@gmail.com"
    },
    {
      icon: FaLinkedin,
      title: "LINKEDIN",
      value: "linkedin./Ayush Singh",
      link: "https://www.linkedin.com/in/ayush-singh-20bb63252?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
    },
    {
      icon: FaGithub,
      title: "GITHUB",
      value: "ayush3686",
      link: "https://github.com/ayush3686"
    }
  ];
    ...
    <section id="contact" className="min-h-screen py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid grid-cols-2 md:grid-cols-3 gap-6 mx-auto"
        >
